...
class AddressSplitterTest extends TestCase
{
    ...
    {
        return [
            '東京都渋谷区' => ['東京都渋谷区恵比寿1-1-1', '東京都', '渋谷区', '恵比寿1-1-1'],
            '北海道札幌市中央区' => ['北海道札幌市中央区大通西1-1-1', '北海道', '札幌市中央区', '大通西1-1-1'],
            '大阪府大阪市北区' => ['大阪府大阪市北区梅田1-1-1', '大阪府', '大阪市北区', '梅田1-1-1'],
            '京都府京都市下京区' => ['京都府京都市下京区四条通1-1-1', '京都府', '京都市下京区', '四条通1-1-1'],
            '都道府県なし' => ['渋谷区恵比寿1-1-1', null, '渋谷区', '恵比寿1-1-1'],
            '空文字列' => ['', null, null, ''],
            '空白のみ' => ['   ', null, null, '   '],
            '市名に市が含まれる' => ['広島県廿日市市1-1-1', '広島県', '廿日市市', '1-1-1'],
            '郡+町' => ['群馬県佐波郡玉村町1丁目2番地3', '群馬県', '佐波郡玉村町', '1丁目2番地3'],
            '郡+村' => ['東京都西多摩郡奥多摩町1-1-1', '東京都', '西多摩郡奥多摩町', '1-1-1'],
            '市名に村が含まれる' => ['東京都東村山市本町1丁目2番地3', '東京都', '東村山市', '本町1丁目2番地3'],
        ];
    }
